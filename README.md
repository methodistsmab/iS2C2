...
**[2025.07.22]** The current iS2C2 supports S2C2 with LLM interpretation, LIANA+ with LLM interpretation, and NicheNet with LLM interpretation.
...
```bash
git clone https://github.com/your-username/iS2C2.git
cd iS2C2
```
...
author={Jianting Sheng, Juyoung Ahn, Li Yang, et al.},
